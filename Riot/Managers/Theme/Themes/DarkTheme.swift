...
class DarkTheme: NSObject, Theme {
    ...
    // Brand-tinted highlight on dark
    var searchResultHighlightColor: UIColor = UIColor(rgb: 0x00A5B1).withAlphaComponent(0.3)
    ...
    // Brand accent (teal)
    var tintColor: UIColor = UIColor(rgb: 0x00A5B1)
    // Subtle brand background for pills, toggles, etc.
    var tintBackgroundColor: UIColor = UIColor(rgb: 0x0E3E42)
    ...
    // Notices lean into the brand; keep error/warning red separate
    var noticeColor: UIColor = UIColor(rgb: 0x00A5B1)
    var noticeSecondaryColor: UIColor = UIColor(rgb: 0x2E7F86)

    var warningColor: UIColor = UIColor(rgb: 0xFF4B55)
    
    var roomInputTextBorder: UIColor = UIColor(rgb: 0x8D97A5).withAlphaComponent(0.2)

    // Avatar palette shifted toward brand family
    ...
    // Username palette, brand-leaning but varied for contrast on dark
    var userNameColors: [UIColor] = [
        UIColor(rgb: 0x007E87),
        UIColor(rgb: 0x00949E),
        UIColor(rgb: 0x00A5B1),
        UIColor(rgb: 0x00BFCB),
        UIColor(rgb: 0x2DC2C5),
        UIColor(rgb: 0x33C6D0),
        UIColor(rgb: 0x5CD9DF),
        UIColor(rgb: 0x3AA39D)
    ]
    ...
    // Dark, brand-tinted secondary circle background
    var secondaryCircleButtonBackgroundColor: UIColor = UIColor(rgb: 0x12383C)
    ...
    // Brand-tinted outgoing bubble
    var roomCellOutgoingBubbleBackgroundColor: UIColor = UIColor(rgb: 0x0D2B2E)
    
    // Use brand for “started” icon
    var roomCellLocalisationIconStartedColor: UIColor = UIColor(rgb: 0x00A5B1)
