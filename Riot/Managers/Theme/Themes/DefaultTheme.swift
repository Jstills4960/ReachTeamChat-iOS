...
class DefaultTheme: NSObject, Theme {
    ...
    // Brand-tinted highlight instead of yellow
    var searchResultHighlightColor: UIColor = UIColor(rgb: 0x00A5B1).withAlphaComponent(0.2)
    ...
    var tintBackgroundColor: UIColor = UIColor(rgb: 0xCDEFF2)
    ...
    var avatarColors: [UIColor] = [
        UIColor(rgb: 0x00A5B1), // base
        UIColor(rgb: 0x007E87), // dark teal
        UIColor(rgb: 0x33C6D0)  // light aqua
    ]
    
    // Username palette, brand-leaning but varied
    ...
    var secondaryCircleButtonBackgroundColor: UIColor = UIColor(rgb: 0xE0F4F6)
    
    var shadowColor: UIColor = UIColor(rgb: 0x000000)
    
    // Subtle brand tint for bubbles
    var roomCellIncomingBubbleBackgroundColor: UIColor = UIColor(rgb: 0xEFF7F8)
    
    var roomCellOutgoingBubbleBackgroundColor: UIColor = UIColor(rgb: 0xE5F7F9)
    
    // Use brand for “started” icon
    var roomCellLocalisationIconStartedColor: UIColor = UIColor(rgb: 0x007E87)
