...
public class VectorL10n: NSObject {
  ...
  /// Nope! You can't leave the room since you're the only owner of it.
  ...
  /// Invite only, best for small groups or teams
  ...
  /// Open to anyone in ReachTeam Chat, best for public chats
